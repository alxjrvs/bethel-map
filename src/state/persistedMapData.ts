import { PersistedHexConfig } from "../types"

export const persistedMapData: PersistedHexConfig[] = [
  {
    borderVisible: true,
    showFeature: false,
    visible: true,
